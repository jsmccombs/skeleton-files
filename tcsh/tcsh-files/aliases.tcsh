##############################################################################
## 
# a lot of these are mine, some come from other places on the 'net.. 
#
...
# Fuck "rm -i". Yes, I tyuped "rm" I WANT to delete the file.
alias rm 	'rm -f'
...
# This spits out open sockets and the processes attached (if lsof is installed)
alias listopen 'lsof -i'
